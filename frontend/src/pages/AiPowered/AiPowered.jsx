...
const dummyAIResponse = (question) => {
  const responses = [
    `Great question! "${question}" relates to several key concepts in the curriculum. The most important aspect to understand is...`,
    `"${question}" is a common topic students ask about. Here's a detailed explanation with examples to help you grasp it better...`,
    `I'd be happy to help with "${question}". This involves understanding a few fundamental principles. Let me break it down for you...`,
    `Interesting question! "${question}" can be approached from multiple perspectives. Here's the most straightforward explanation...`,
    `Thanks for asking about "${question}". This is a crucial concept that builds on what you learned previously. Here's how it works...`,
  ];
  return (
...
const AiPowered = () => {
  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      const aiMsg = { role: "ai", content: dummyAIResponse(question) };
